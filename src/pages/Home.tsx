        ...
        <div className="relative rounded-3xl p-8 md:p-12 text-center shadow-xl flex flex-col items-center border border-white/20 overflow-hidden bg-gray-900 group">
          ...
          <div className="relative z-10 w-full flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full justify-center mt-6">
              <Link to="/sell" className="bg-white text-brand-green text-lg font-bold px-10 py-4 rounded-xl shadow-lg hover:bg-gray-50 transition-all">Post Property Free</Link>
              <Link to="/find-agent" className="bg-white/10 backdrop-blur-md text-white text-lg font-bold px-10 py-4 rounded-xl shadow-lg border border-white/30 hover:bg-white/20 transition-all flex items-center justify-center gap-2">
                <UserCheck size={20} /> Find An Agent
              </Link>
            </div>
          </div>
        </div>
